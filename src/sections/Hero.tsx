...
export const HeroSection = () => {
  ...
  <div className='py-32 md:py-48 lg:py-60 relative z-0 overflow-x-clip'>
    ...
    <div className='flex items-center flex-col'>
      <Image src={avatar} alt="avatar" className="size-[100px]" />
      <div className='inline-flex bg-gray-950 border border-gray-800 px-4 py-1.5 items-center gap-4 rounded-lg'>
        <div className='bg-green-500 size-2.5 rounded-full relative'>
          <div className='bg-green-500 size-2.5 rounded-full absolute animate-ping-large'></div>
        </div>
        <div className='text-sm font-medium'>Actively Seeking Opportunities </div>
      </div>
    </div>  
    <div className='max-w-lg mx-auto'>
      <h1 className='font-serif text-4xl md:text-6xl text-center mt-8 tracking-wide'>
        I&apos;m Aniket Goyal -Web Developer
      </h1>
      <p className='mt-4 text-center text-white/60 md:text-lg'>
        Crafting digital experiences that scale seamlessly. I turn complex challenges into elegant, high-performance solutions. 
      </p>
    </div>
